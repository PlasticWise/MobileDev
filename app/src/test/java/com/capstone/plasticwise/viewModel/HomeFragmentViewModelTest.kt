...
import com.capstone.plasticwise.DataDummy
import com.capstone.plasticwise.MainDispatcherRule
...
//        val data: PagingData<QuoteResponseItem> = PagingData.from(dummyQuote)
        ...
        Mockito.`when`(authenticationRepository.getStory()).thenReturn(expectedQuote)

        val mainViewModel = HomeFragmentViewModel(authenticationRepository)
